...
bool PluginCore::initPluginParameters()
{
	...
	// --- meter control: Lows Down
	piParam = new PluginParameter(controlID::mLowsDown, "Lows Down", 0.00, 0.00, ENVELOPE_DETECT_MODE_PEAK, meterCal::kLinearMeter);
	piParam->setInvertedMeter(true);
	piParam->setBoundVariable(&mLowsDown, boundVariableType::kFloat);
	addPluginParameter(piParam);

	// --- meter control: Lows Up
	piParam = new PluginParameter(controlID::mLowsUp, "Lows Up", 0.00, 0.00, ENVELOPE_DETECT_MODE_PEAK, meterCal::kLinearMeter);
	piParam->setBoundVariable(&mLowsUp, boundVariableType::kFloat);
	addPluginParameter(piParam);

	// --- continuous control: Lows Gain
	piParam = new PluginParameter(controlID::lowsGain, "Lows Gain", "dB", controlVariableType::kFloat, -40.000000, 10.000000, 0.000000, taper::kLinearTaper);
	piParam->setParameterSmoothing(true);
	piParam->setSmoothingTimeMsec(20.00);
	piParam->setBoundVariable(&lowsGain, boundVariableType::kFloat);
	addPluginParameter(piParam);

	// --- continuous control: Low Mids Gain
	piParam = new PluginParameter(controlID::lowMidsGain, "Low Mids Gain", "dB", controlVariableType::kFloat, -40.000000, 10.000000, 0.000000, taper::kLinearTaper);
	piParam->setParameterSmoothing(true);
	piParam->setSmoothingTimeMsec(20.00);
	piParam->setBoundVariable(&lowMidsGain, boundVariableType::kFloat);
	addPluginParameter(piParam);

	// --- continuous control: High Mids Gain
	piParam = new PluginParameter(controlID::highMidsGain, "High Mids Gain", "dB", controlVariableType::kFloat, -40.000000, 10.000000, 0.000000, taper::kLinearTaper);
	piParam->setParameterSmoothing(true);
	piParam->setSmoothingTimeMsec(20.00);
	piParam->setBoundVariable(&highMidsGain, boundVariableType::kFloat);
	addPluginParameter(piParam);

	// --- continuous control: Highs Gain
	piParam = new PluginParameter(controlID::highsGain, "Highs Gain", "dB", controlVariableType::kFloat, -40.000000, 10.000000, 0.000000, taper::kLinearTaper);
	piParam->setParameterSmoothing(true);
	piParam->setSmoothingTimeMsec(20.00);
	piParam->setBoundVariable(&highsGain, boundVariableType::kFloat);
	addPluginParameter(piParam);

	// --- continuous control: Dry/Wet
	piParam = new PluginParameter(controlID::dryWet, "Dry/Wet", "Units", controlVariableType::kFloat, 0.000000, 100.000000, 100.000000, taper::kLinearTaper);
	piParam->setParameterSmoothing(true);
	piParam->setSmoothingTimeMsec(20.00);
	piParam->setBoundVariable(&dryWet, boundVariableType::kFloat);
	addPluginParameter(piParam);

	// --- continuous control: Up
	piParam = new PluginParameter(controlID::upMult, "Up", "Units", controlVariableType::kFloat, -100.000000, 100.000000, 0.000000, taper::kLinearTaper);
	piParam->setParameterSmoothing(true);
	piParam->setSmoothingTimeMsec(20.00);
	piParam->setBoundVariable(&upMult, boundVariableType::kFloat);
	addPluginParameter(piParam);

	// --- continuous control: Right
	piParam = new PluginParameter(controlID::rightMult, "Right", "Units", controlVariableType::kFloat, 1.000000, 100.000000, 1.000000, taper::kLinearTaper);
	piParam->setParameterSmoothing(true);
	piParam->setSmoothingTimeMsec(20.00);
	piParam->setBoundVariable(&rightMult, boundVariableType::kFloat);
	addPluginParameter(piParam);

	// --- continuous control: Down
	piParam = new PluginParameter(controlID::downMult, "Down", "Units", controlVariableType::kFloat, -100.000000, 100.000000, 0.000000, taper::kLinearTaper);
	piParam->setParameterSmoothing(true);
	piParam->setSmoothingTimeMsec(20.00);
	piParam->setBoundVariable(&downMult, boundVariableType::kFloat);
	addPluginParameter(piParam);

	// --- continuous control: Left
	piParam = new PluginParameter(controlID::leftMult, "Left", "Units", controlVariableType::kFloat, 1.000000, 100.000000, 1.000000, taper::kLinearTaper);
	piParam->setParameterSmoothing(true);
	piParam->setSmoothingTimeMsec(20.00);
	piParam->setBoundVariable(&leftMult, boundVariableType::kFloat);
	addPluginParameter(piParam);

	// --- meter control: Low Mids Down
	piParam = new PluginParameter(controlID::mLowMidsDown, "Low Mids Down", 0.00, 0.00, ENVELOPE_DETECT_MODE_PEAK, meterCal::kLinearMeter);
	piParam->setInvertedMeter(true);
	piParam->setBoundVariable(&mLowMidsDown, boundVariableType::kFloat);
	addPluginParameter(piParam);

	// --- meter control: Low Mids Up
	piParam = new PluginParameter(controlID::mLowMidsUp, "Low Mids Up", 0.00, 0.00, ENVELOPE_DETECT_MODE_PEAK, meterCal::kLinearMeter);
	piParam->setBoundVariable(&mLowMidsUp, boundVariableType::kFloat);
	addPluginParameter(piParam);

	// --- meter control: High Mids Down
	piParam = new PluginParameter(controlID::mHighMidsDown, "High Mids Down", 0.00, 0.00, ENVELOPE_DETECT_MODE_PEAK, meterCal::kLinearMeter);
	piParam->setInvertedMeter(true);
	piParam->setBoundVariable(&mHighMidsDown, boundVariableType::kFloat);
	addPluginParameter(piParam);

	// --- meter control: High Mids Up
	piParam = new PluginParameter(controlID::mHighMidsUp, "High Mids Up", 0.00, 0.00, ENVELOPE_DETECT_MODE_PEAK, meterCal::kLinearMeter);
	piParam->setBoundVariable(&mHighMidsUp, boundVariableType::kFloat);
	addPluginParameter(piParam);

	// --- meter control: Highs Down
	piParam = new PluginParameter(controlID::mHighsDown, "Highs Down", 0.00, 0.00, ENVELOPE_DETECT_MODE_PEAK, meterCal::kLinearMeter);
	piParam->setInvertedMeter(true);
	piParam->setBoundVariable(&mHighsDown, boundVariableType::kFloat);
	addPluginParameter(piParam);

	// --- meter control: Highs Up
	piParam = new PluginParameter(controlID::mHighsUp, "Highs Up", 0.00, 0.00, ENVELOPE_DETECT_MODE_PEAK, meterCal::kLinearMeter);
	piParam->setBoundVariable(&mHighsUp, boundVariableType::kFloat);
	addPluginParameter(piParam);

	// --- discrete control: Bypass
	piParam = new PluginParameter(controlID::bypass, "Bypass", "SWITCH OFF,SWITCH ON", "SWITCH ON");
	piParam->setBoundVariable(&bypass, boundVariableType::kInt);
	piParam->setIsDiscreteSwitch(true);
	addPluginParameter(piParam);

	// --- continuous control: Input Gain
	piParam = new PluginParameter(controlID::m_inputGain, "Input Gain", "dB", controlVariableType::kFloat, -20.000000, 10.000000, 0.000000, taper::kLinearTaper);
	piParam->setParameterSmoothing(true);
	piParam->setSmoothingTimeMsec(20.00);
	piParam->setBoundVariable(&m_inputGain, boundVariableType::kFloat);
	addPluginParameter(piParam);

	// --- discrete control: Reset
	piParam = new PluginParameter(controlID::resetButton, "Reset", "SWITCH OFF,SWITCH ON", "SWITCH OFF");
	piParam->setBoundVariable(&resetButton, boundVariableType::kInt);
	piParam->setIsDiscreteSwitch(true);
	addPluginParameter(piParam);
	...
	setParamAuxAttribute(controlID::mLowsDown, auxAttribute);

	// --- controlID::mLowsUp
	auxAttribute.reset(auxGUIIdentifier::guiControlData);
	auxAttribute.setUintAttribute(201326592);
	setParamAuxAttribute(controlID::mLowsUp, auxAttribute);

	// --- controlID::lowsGain
	auxAttribute.reset(auxGUIIdentifier::guiControlData);
	auxAttribute.setUintAttribute(2147483685);
	setParamAuxAttribute(controlID::lowsGain, auxAttribute);

	// --- controlID::lowMidsGain
	auxAttribute.reset(auxGUIIdentifier::guiControlData);
	auxAttribute.setUintAttribute(2147483685);
	setParamAuxAttribute(controlID::lowMidsGain, auxAttribute);

	// --- controlID::highMidsGain
	auxAttribute.reset(auxGUIIdentifier::guiControlData);
	auxAttribute.setUintAttribute(2147483685);
	setParamAuxAttribute(controlID::highMidsGain, auxAttribute);

	// --- controlID::highsGain
	auxAttribute.reset(auxGUIIdentifier::guiControlData);
	auxAttribute.setUintAttribute(2147483685);
	setParamAuxAttribute(controlID::highsGain, auxAttribute);

	// --- controlID::dryWet
	auxAttribute.reset(auxGUIIdentifier::guiControlData);
	auxAttribute.setUintAttribute(2147483683);
	setParamAuxAttribute(controlID::dryWet, auxAttribute);

	// --- controlID::upMult
	auxAttribute.reset(auxGUIIdentifier::guiControlData);
	auxAttribute.setUintAttribute(2147483689);
	setParamAuxAttribute(controlID::upMult, auxAttribute);

	// --- controlID::rightMult
	auxAttribute.reset(auxGUIIdentifier::guiControlData);
	auxAttribute.setUintAttribute(2147483689);
	setParamAuxAttribute(controlID::rightMult, auxAttribute);

	// --- controlID::downMult
	auxAttribute.reset(auxGUIIdentifier::guiControlData);
	auxAttribute.setUintAttribute(2147483689);
	setParamAuxAttribute(controlID::downMult, auxAttribute);

	// --- controlID::leftMult
	auxAttribute.reset(auxGUIIdentifier::guiControlData);
	auxAttribute.setUintAttribute(2147483689);
	setParamAuxAttribute(controlID::leftMult, auxAttribute);

	// --- controlID::mLowMidsDown
	auxAttribute.reset(auxGUIIdentifier::guiControlData);
	auxAttribute.setUintAttribute(201326592);
	setParamAuxAttribute(controlID::mLowMidsDown, auxAttribute);

	// --- controlID::mLowMidsUp
	auxAttribute.reset(auxGUIIdentifier::guiControlData);
	auxAttribute.setUintAttribute(201326592);
	setParamAuxAttribute(controlID::mLowMidsUp, auxAttribute);

	// --- controlID::mHighMidsDown
	auxAttribute.reset(auxGUIIdentifier::guiControlData);
	auxAttribute.setUintAttribute(201326592);
	setParamAuxAttribute(controlID::mHighMidsDown, auxAttribute);

	// --- controlID::mHighMidsUp
	auxAttribute.reset(auxGUIIdentifier::guiControlData);
	auxAttribute.setUintAttribute(201326592);
	setParamAuxAttribute(controlID::mHighMidsUp, auxAttribute);

	// --- controlID::mHighsDown
	auxAttribute.reset(auxGUIIdentifier::guiControlData);
	auxAttribute.setUintAttribute(201326592);
	setParamAuxAttribute(controlID::mHighsDown, auxAttribute);

	// --- controlID::mHighsUp
	auxAttribute.reset(auxGUIIdentifier::guiControlData);
	auxAttribute.setUintAttribute(201326592);
	setParamAuxAttribute(controlID::mHighsUp, auxAttribute);

	// --- controlID::bypass
	auxAttribute.reset(auxGUIIdentifier::guiControlData);
	auxAttribute.setUintAttribute(1073741824);
	setParamAuxAttribute(controlID::bypass, auxAttribute);

	// --- controlID::m_inputGain
	auxAttribute.reset(auxGUIIdentifier::guiControlData);
	auxAttribute.setUintAttribute(2147483691);
	setParamAuxAttribute(controlID::m_inputGain, auxAttribute);

	// --- controlID::resetButton
	auxAttribute.reset(auxGUIIdentifier::guiControlData);
	auxAttribute.setUintAttribute(1610612736);
	setParamAuxAttribute(controlID::resetButton, auxAttribute);


	// **--0xEDA5--**

	//kernel.push section
	kernel.push(&mLowsDown, boundVariableType::kFloat, controlID::mLowsDown);
	kernel.push(&mLowsUp, boundVariableType::kFloat, controlID::mLowsUp);
	kernel.push(&mLowMidsDown, boundVariableType::kFloat, controlID::mLowMidsDown);
	kernel.push(&mLowMidsUp, boundVariableType::kFloat, controlID::mLowMidsUp);
	kernel.push(&mHighMidsDown, boundVariableType::kFloat, controlID::mHighMidsDown);
	kernel.push(&mHighMidsUp, boundVariableType::kFloat, controlID::mHighMidsUp);
	kernel.push(&mHighsDown, boundVariableType::kFloat, controlID::mHighsDown);
	kernel.push(&mHighsUp, boundVariableType::kFloat, controlID::mHighsUp);

	kernel.push(&lowsGain, boundVariableType::kFloat, controlID::lowsGain);
	kernel.push(&lowMidsGain, boundVariableType::kFloat, controlID::lowMidsGain);
	kernel.push(&highMidsGain, boundVariableType::kFloat, controlID::highMidsGain);
	kernel.push(&highsGain, boundVariableType::kFloat, controlID::highsGain);

	kernel.push(&upMult, boundVariableType::kFloat, controlID::upMult);
	kernel.push(&downMult, boundVariableType::kFloat, controlID::downMult);
	kernel.push(&leftMult, boundVariableType::kFloat, controlID::leftMult);
	kernel.push(&rightMult, boundVariableType::kFloat, controlID::rightMult);

	kernel.push(&dryWet, boundVariableType::kFloat, controlID::dryWet);
	kernel.push(&bypass, boundVariableType::kInt, controlID::bypass);
	kernel.push(&m_inputGain, boundVariableType::kFloat, controlID::m_inputGain);
	kernel.push(&resetButton, boundVariableType::kInt, controlID::resetButton);
...
bool PluginCore::initPluginPresets()
{
	...
	setPresetParameter(preset->presetParameters, controlID::lowsGain, 0.000000);
	setPresetParameter(preset->presetParameters, controlID::lowMidsGain, 0.000000);
	setPresetParameter(preset->presetParameters, controlID::highMidsGain, 0.000000);
	setPresetParameter(preset->presetParameters, controlID::highsGain, 0.000000);
	setPresetParameter(preset->presetParameters, controlID::dryWet, 100.000000);
	setPresetParameter(preset->presetParameters, controlID::upMult, 0.000000);
	setPresetParameter(preset->presetParameters, controlID::rightMult, 1.000000);
	setPresetParameter(preset->presetParameters, controlID::downMult, 0.000000);
	setPresetParameter(preset->presetParameters, controlID::leftMult, 1.000000);
	setPresetParameter(preset->presetParameters, controlID::bypass, 1.000000);
	setPresetParameter(preset->presetParameters, controlID::m_inputGain, 0.000000);
	setPresetParameter(preset->presetParameters, controlID::resetButton, -0.000000);
	addPreset(preset);

	// --- Preset: Test
	preset = new PresetInfo(index++, "Test");
	initPresetParameters(preset->presetParameters);
	setPresetParameter(preset->presetParameters, controlID::lowsGain, 0.000000);
	setPresetParameter(preset->presetParameters, controlID::lowMidsGain, 0.000000);
	setPresetParameter(preset->presetParameters, controlID::highMidsGain, -1.250000);
	setPresetParameter(preset->presetParameters, controlID::highsGain, 9.000000);
	setPresetParameter(preset->presetParameters, controlID::dryWet, 100.000000);
	setPresetParameter(preset->presetParameters, controlID::upMult, -67.000000);
	setPresetParameter(preset->presetParameters, controlID::rightMult, 29.709999);
	setPresetParameter(preset->presetParameters, controlID::downMult, 52.000000);
	setPresetParameter(preset->presetParameters, controlID::leftMult, 34.164997);
	setPresetParameter(preset->presetParameters, controlID::bypass, 1.000000);
	setPresetParameter(preset->presetParameters, controlID::m_inputGain, -11.400000);
	setPresetParameter(preset->presetParameters, controlID::resetButton, -0.000000);
	addPreset(preset);
